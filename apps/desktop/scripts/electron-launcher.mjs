// This file mostly exists because we want dev mode to say "T3M0 (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "T3M0 (Dev)" : "T3M0 (Alpha)";
const APP_BUNDLE_ID = isDevelopment ? "com.t3m0.app.dev" : "com.t3m0.app";
